...
#define DIO_PORT_LOW 	0    //to make the whole port with output value zero
#define DIO_PORT_HIGH  255   //to make the whole port with output value zero

#define DIO_PORT_OUTPUT 255  //to make the whole port direction >> output 
#define DIO_PORT_INPUT 0     //to make the whole port direction >> input 
